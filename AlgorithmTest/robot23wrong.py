...
positions = np.array([[13, 30], [7, 35], [10, 40]]) #first test case 
goal = [10, 40]
...
for step in range(steps):
    ...
    if uwb_distance12 < 5.1 and uwb_distance12 > 4.9 and not correctPos2:
        ...
        correctPos2 = True
    if uwb_distance13 < 10.3 and uwb_distance13 > 9.7 and not correctPos3:
        print("CORRECT POS ROBOT 3")
        correctPos3 = True
    if correctPos2 and uwb_distance13 < 10.3 and uwb_distance13 > 9.7 and uwb_distance23 < 5.1 and uwb_distance23 > 4.9:
