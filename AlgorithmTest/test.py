...
for step in range(steps):
    ...
    if uwb_distance13 < 10.5 and uwb_distance13 > 9.5 and not correctPos3:
        ...
        correctPos3 = True
    if correctPos2 and correctPos3 and uwb_distance23 < 5.1 and uwb_distance23 > 4.9:
    ...
    if not correctPos23:
        ...
        if new_uwb_distance12 < 8 and new_uwb_distance23 < 8 and np.abs(new_uwb_distance12 - 5) < np.abs(uwb_distance12 - 5) or np.abs(new_uwb_distance23 - 5) < np.abs(uwb_distance23 - 5):
            #new distance is closer, continue moving in that direction
            dfound_x = movement[0]
            dfound_y = movement[1]
            currentMoves.clear()
